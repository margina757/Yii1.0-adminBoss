...
<div class="rows">
    <div class="widget">
        ...
        //CActiveForm $url = "/cusAddons/updateCusAddons/id/{$model->id}/urlPre/{$urlPre}";
        $form = $this->beginWidget('CActiveForm',array(
            ...
            <div class="customer" style="position: relative;">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           // echo $form->dropDownListControlGroup($model,'cid',$channelList,array('empty'=>'请选择分类所属频道'));
                            ?></td>
               ...
               <div class="nr"><?php echo $form->label($model,'body'); ?></div>
                ...
                <div class="box-in">
                    <button type="submit" class="btn btn-large agnore ">添加</button>
                </div>
                <div id="color-box">
                    <ul>
                        <?php 
