<?php
$this->title = '文章添加 - ' . $this->titleTail;
?>
<style type="text/css">
	.soft-content {
		...
		<ul class="soft-content">
			...
			<li>
				<div class="control-group">
					...
					<div class="controls">
						<input  type="checkbox" name="ArticleContentModel[flag][]"  value="h">头条[h]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]"  value="c">推荐[c]&nbsp;
						<input type="checkbox" name="ArticleContentModel[flag][]" value="p">图片[p]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]" value="f">幻灯[f]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]" value="s">滚动[s]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]" value="j">跳转[j]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]" value="a">图文[a]&nbsp;
						<input  type="checkbox" name="ArticleContentModel[flag][]" value="b">加粗[b]
					</div>
				</div>
			</li>
			...
			<li>
				...
				<div class="control-group" id="digital-box" style="display:none;">
					...
					<div class="controls">
						<input name="DigitalResourcesModel[url]" id="DigitalResourcesModel_url" type="text" maxlength="200">
