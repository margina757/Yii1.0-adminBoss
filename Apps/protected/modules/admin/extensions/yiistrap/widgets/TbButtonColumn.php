...
class TbButtonColumn extends CButtonColumn
{
    ...
    /**
     * @var string the download button icon (defaults to TbHtml::ICON_DOWNLOAD_ALT).
     * @author zhanghaolei@lonlife.net
     */
    public $downloadButtonIcon = TbHtml::ICON_DOWNLOAD_ALT;
    ...
    protected function initDefaultButtons()
    {
        ...
        if ($this->downloadButtonIcon !== false && !isset($this->buttons['download']['icon'])) {
            $this->buttons['download']['icon'] = $this->downloadButtonIcon;
        }
    }
